...
async function main() {
  ...
  try {
    ...
    const subscribers = new ethers.Contract(subscribersContractAddress, subscribersContractAbi, signer)


    const getSubscriptionDataTx = await subscribers.getSubscriptionData(signer.address)
    // console.log("getSubscriptionDataTx:", getSubscriptionDataTx)

    const getSubscriptionTokenIdTx = await subscribers.getSubscriptionTokenId(signer.address)
